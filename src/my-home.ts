...
export class MyHome extends LitElement {
  ...
  async _updHist() {
    const res = await fetch('https://notify-api-prac.azurewebsites.net/api/Users/GetNotifyHist', {
      method: 'GET',
      mode: 'cors',
      cache: 'no-cache',
      credentials: 'include',
  ...
  private async _notify() {
    ...
    const res = await fetch('https://notify-api-prac.azurewebsites.net/api/Users/NotifyMsg', {
      method: 'POST',
      mode: 'cors',
      cache: 'no-cache',
      credentials: 'include',
