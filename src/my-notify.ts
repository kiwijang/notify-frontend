...
export class MyNotify extends LitElement {
  ...
  connectedCallback() {
    ...
    if (code && state) {
      fetch('https://notify-api-prac.azurewebsites.net/api/Users/GetNotifyToken', {
        method: 'POST',
        mode: 'cors',
        cache: 'no-cache',
        credentials: 'include',
  ...
  private async _GetNotifyCode() {
    // 檢查是否有 notify
    fetch('https://notify-api-prac.azurewebsites.net/api/Users/GetNotifyStatus', {
      method: 'GET',
      mode: 'cors',
      cache: 'no-cache',
      credentials: 'include',
  ...
  private _getCode() {
    ...
    url.searchParams.append('redirect_uri', 'https://thankful-plant-0f318751e.3.azurestaticapps.net/');
  ...
  private _RevokeNotify() {
    ...
    fetch('https://notify-api-prac.azurewebsites.net/api/Users/RevokeNotify', {
      method: 'GET',
      mode: 'cors',
      cache: 'no-cache',
      credentials: 'include',
